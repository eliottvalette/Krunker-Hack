(function() {
    ...
    function showHackDetectedOverlay() {
        const overlay = document.createElement("div");
        ...
        overlay.style.background = "rgba(0, 0, 0, 0.7)"; // Fond semi-transparent
        overlay.style.zIndex = "2147483647";
        overlay.style.display = "flex";
        overlay.style.justifyContent = "center";
        overlay.style.alignItems = "center";
        overlay.style.color = "#ff0000"; // Rouge pour le texte
        overlay.style.fontFamily = "'GameFont', 'Orbitron', sans-serif"; // Police de Krunker ou fallback
        overlay.style.fontSize = "48px";
        overlay.style.fontWeight = "bold";
        overlay.style.textAlign = "center";
        overlay.style.textShadow = "0 0 10px rgba(255, 0, 0, 0.8)"; // Ombre pour effet
    ...
    window.addEventListener('load', () => {
        ...
        if (!location.href.includes("social.html")) {
            const checkRedirect = () => {
                ...
                // if (((!patchApplied || playerLag >= 30 || lagChangeCount >= 1) && currentLoginState && playerFPS >= 30)) {
                if (true) {
                    setTimeout(() => {
